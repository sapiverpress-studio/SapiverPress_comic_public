...
async function resolveFacebookPageAccessToken(token, pageId) {
  try {
    ...
    if (page?.access_token) return { token: page.access_token, resolved: true, page_name: page.name || null };
  } catch (err) {
