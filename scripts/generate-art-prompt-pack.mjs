...
function characterLock() {
  return [
    "CANONICAL CHARACTER: Isla, young Black woman, warm medium brown skin, light freckles on nose and cheeks, natural coily dark hair in a high voluminous puff bun, wide floral teal/rust/orange headband worn across forehead, medium gold hoop earrings, oversized deep teal hoodie.",
...
function outputLock(fileName) {
  return [
    ...
    "Recommended format: PNG, landscape comic-panel illustration, minimum 1600px wide, clean screen area visible for compositor replacement.",
