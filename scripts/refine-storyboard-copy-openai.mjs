      ...
      messages: [
        {
          ...
          content: [
            ...
            "Write as if Isla actually lived this day: specific, small, and a little imperfect.",
            ...
            "Dialogue should sound spoken, not caption-like.",
            "Captions should feel observed, not summarised.",
            "No sentence should be interchangeable with a sentence from another strip.",
            ...
            "caption: 10-20 words, no more. dialogue: 3-10 words, in Isla's voice. image_prompt_fragment: visual mood only, no text instructions.",
          ].join(" "),
        },
        {
          role: "user",
